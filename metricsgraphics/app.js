+function () {
  ...
  demoApp.controller('TimeSeriesCtrl', ['$scope', function ($scope) {
    ...
    $scope.ts = [
      _.map(dataset, function (val, i) {
        return {
          x: val,
          t: i*MONTHS
        };
      }),
      _.map(unicorns, function (val, i) {
        return {
          x: val,
          t: i*MONTHS
        };
  ...
  demoApp.directive('ksTimeSeries', [
    '$rootScope', '$window',
      ...
      link: function (scope, el) {
        ...
        scope.$watch(function () {
          ...
          MG.data_graphic({
            ...
            width: width,
            height: height,
            xax_format: function (dd) {
              return moment(dd).format('MMM YYYY');
            },
            area: false
          });
        });
